...
export default function Home() {
  ...
  const faqs = [
    ...
    {
      question: "What if I need CRM or billing later?",
      answer:
        "Add modules later or use intergations - start lightwieght, expand on demand.",
    },
    {
      question: "Can I control my schedule manually?",
      answer:
        "Absolutely! NovaSuite offers AI task management that suggests priorities and automates reminders, but you can always adjust your schedule manually without rigid rules.",
    },
    ...
    <section className="w-full py-16 px-6">
      <div className="container mx-auto flex flex-col lg:flex-row items-center">
        ...
        <div className="lg:w-1/2 text-center lg:text-left space-y-6">
          ...
          Task-focused simplicity for growing teams
          </h1>

          {/* Body Text */}
          <p className="text-base text-gray-600">
          The lighweight SaaS built for remote-first startups and SMBs -- works solo, scales as you grow. AI-powered task management, light CRM, integrated analytics, no unnecessary features.
          </p>
          <p className="text-base text-gray-600">
          ...
          <div className="flex space-x-4 justify-center md:justify-start lg:justiy-start">
            <button 
              ...
              Join Earyl Access - Lifetime Access & Special Pricing
            </button>
          </div>
    ...
    {/* About */}
      ...
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-10" >
        ...
        <div className="bg-gray-100 p-6 rounded-xl text-center space-y-6">
          ...
          <p className="text-gray-600">Track tasks, sales, projects, and team activity in one place - easy insights, no extra tools.</p>
          <p className="text-gray-600 text-sm">(One snapshot, full clarity.)</p>
        ...
        <div className="bg-gray-100 p-6 rounded-xl text-center space-y-6">
          ...
          <p className="text-gray-600">Choose the modules you need - projects, client tracking, invoices, analytics.Vertical SaaS made flexible</p>
          <p className="text-gray-600 text-sm">(Only what you use, zero bloat)</p>
        </div>
        ...
        {/* Column 4 */}
        <div className="bg-gray-100 p-6 rounded-xl text-center space-y-6">
          <h3 className="text-xl font-semibold">Designed for Speed & Usability</h3>
          <p className="text-gray-600">Clean UX with onboarding that scales - no complex menus, no unnecessary modes.</p>
          <p className="text-gray-600 text-sm">(Your team can be productive day one.)</p>

        </div>

        {/* Column 5 */}
        <div className="bg-gray-100 p-6 rounded-xl text-center space-y-6">
          <h3 className="text-xl font-semibold">Team & Solo Flexibility</h3>
          <p className="text-gray-600">Works for founders running solo or for teams collaborating - granular access control, shared spaces, and more.</p> 
